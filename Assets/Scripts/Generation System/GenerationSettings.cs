...
public class GenerationSettings : ScriptableObject
{
    ...
    [field: SerializeField] public float PropellerFrequency { get; private set; } = 0.01f;
    [field: SerializeField] public float JetpackFrequency { get; private set; } = 0.007f;
    [field: SerializeField] public float BoosterMinHeight { get; private set; } = 30f;

    [Header("Static Booster Settings")]
    [field: SerializeField] public float SpringFrequency { get; private set; } = 0.05f;
